package com.booking.apigateway.route;
...
public class InventoryServiceRoutes {
    ...
    public RouterFunction<ServerResponse> inventoryRoutes(){
        ...
        .route(RequestPredicates.path("/api/v1/inventory/venue/{venueId}"), request -> forwardWithPathVariable(request, "venueId", "http://localhost:8081/api/v1/inventory/venue/"))
        .route(RequestPredicates.path("api/v1/inventory/event/{eventId}"), request -> forwardWithPathVariable(request, "eventId", "http://localhost:8081/api/v1/inventort/event/"))
                .build();
    }
